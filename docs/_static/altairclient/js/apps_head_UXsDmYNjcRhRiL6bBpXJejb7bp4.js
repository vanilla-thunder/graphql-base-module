;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="a4a292aa3a29994589b0cac7bd9b97d3";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
    ...
    CloudflareApps.matchPage=function matchPage(patterns){if(!patterns||!patterns.length){return true}
        ...
        return false}}());CloudflareApps.installs["l0kE5wPNyBIA"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["l0kE5wPNyBIA"].options={"id":"UA-41432833-8","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['l0kE5wPNyBIA'].URLPatterns)){(function(){var options=CloudflareApps.installs['l0kE5wPNyBIA'].options
    var id
    ...
    if(!id){console.log('Cloudflare Google Analytics: Disabled. UA-ID not present.')
        return}else if("l0kE5wPNyBIA"==='preview'){console.log('Cloudflare Google Analytics: Enabled',id)}
